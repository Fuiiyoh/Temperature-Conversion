...
class HistoryExport:
    ...
    def __init__(self, partner, calc_list):
        ...
        # If user press cross at top, close history and
        ...
        # Customise text and background color for calculation
    ...
    def get_calc_string(self, var_calculations):
        # get max calculations to display
        ...
        # to output either the last 5 calculations
        ...
        # ie: last item on list will be 5th from the end!
